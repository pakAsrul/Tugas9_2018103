...
public class MovieRecycleView extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
        ...
        for (float j = 1.0f; j <= 1.9f; j += 0.1f) {
            if (rating == j) {
                dots[0].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
            }
        }
        ...
        for (float j = 3.0f; j <= 3.9f; j += 0.1f) {
            if (rating == j) {
                dots[0].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[1].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
            }
        }
        ...
        for (float j = 5.0f; j <= 5.9f; j += 0.1f) {
            if (rating == j) {
                dots[0].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[1].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[2].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
            }
        }
        ...
        for (float j = 7.0f; j <= 7.9f; j += 0.1f) {
            if (rating == j) {
                ...
                dots[1].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[2].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[3].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
            }
        }
        ...
        for (float j = 9.0f; j <= 9.9f; j += 0.1f) {
            if (rating == j) {
                ...
                dots[2].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[3].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
                dots[4].setTextColor(holder.itemView.getResources().getColor(R.color.redsemi));
            }
        }
